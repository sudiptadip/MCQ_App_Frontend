                        ...
                        <div className="grid grid-cols-1 gap-4">
                            {currentQuestion.options.map((option, idx) => {
                                ...
                                return (
                                    ...
                                    >
                                        <div className={`h-8 w-8 rounded-lg border-2 flex items-center justify-center font-bold transition-colors ${
                                            isSelected ? 'bg-primary border-primary text-white' : 'border-muted-foreground/30 text-muted-foreground group-hover:border-primary/50 group-hover:text-primary'
                                        }`}>
