         ...
         <div className="space-y-10 animate-in fade-in duration-700">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
               <div className="group bg-card p-6 rounded-[2rem] border border-border shadow-md dark:shadow-none transition-all hover:shadow-xl hover:-translate-y-1">
                  ...
                  <p className="text-3xl font-black text-slate-900 dark:text-zinc-50">0</p>
               </div>
               ...
               <div className="group bg-card p-6 rounded-[2rem] border border-border shadow-md dark:shadow-none transition-all hover:shadow-xl hover:-translate-y-1">
                  ...
                  <p className="text-3xl font-black text-slate-900 dark:text-zinc-50">0h</p>
               </div>
      ...
      <div className="space-y-8 animate-in fade-in duration-700">
         ...
         <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="group bg-card p-6 rounded-[2rem] border border-border shadow-md dark:shadow-none transition-all hover:shadow-xl hover:-translate-y-1">
               ...
               <p className="text-3xl font-black text-slate-900 dark:text-zinc-50">1,284</p>
            </div>

            <div className="group bg-card p-6 rounded-[2rem] border border-border shadow-md dark:shadow-none transition-all hover:shadow-xl hover:-translate-y-1">
               <div className="flex justify-between items-start mb-4">
                  <div className="h-12 w-12 rounded-2xl bg-purple-50 dark:bg-purple-950/20 flex items-center justify-center text-purple-600 dark:text-purple-400 group-hover:scale-110 transition-transform">
                     <BookOpen size={24} />
                  </div>
                  <span className="flex items-center text-xs font-bold text-emerald-500 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-950/20 px-2 py-1 rounded-lg">
               ...
               <p className="text-3xl font-black text-slate-900 dark:text-zinc-50">8,592</p>
            </div>

            <div className="group bg-card p-6 rounded-[2rem] border border-border shadow-md dark:shadow-none transition-all hover:shadow-xl hover:-translate-y-1">
               <div className="flex justify-between items-start mb-4">
                  <div className="h-12 w-12 rounded-2xl bg-amber-50 dark:bg-amber-950/20 flex items-center justify-center text-amber-600 dark:text-amber-400 group-hover:scale-110 transition-transform">
                     <ClipboardCheck size={24} />
                  </div>
               </div>
               <p className="text-[10px] font-black uppercase tracking-widest text-slate-400 mb-1">Active Tests</p>
               <p className="text-3xl font-black text-slate-900 dark:text-zinc-50">45</p>
            </div>
            ...
            <div className="group bg-card p-6 rounded-[2rem] border border-border shadow-md dark:shadow-none transition-all hover:shadow-xl hover:-translate-y-1">
               ...
               <p className="text-3xl font-black text-slate-900 dark:text-zinc-50">78%</p>
            </div>
         </div>
         ...
         <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 space-y-6">
               ...
               <div className="bg-card rounded-[2rem] border border-border shadow-md dark:shadow-none p-6">
                  <div className="space-y-6">
                     {[
                        { icon: <UserPlus className="text-blue-500" size={18} />, bg: 'bg-blue-50 dark:bg-blue-950/20', title: 'New Student Registered', desc: 'Sarah Jenkins joined standard tier', time: '10 mins ago' },
                        { icon: <FileEdit className="text-purple-500" size={18} />, bg: 'bg-purple-50 dark:bg-purple-950/20', title: 'Test Updated', desc: 'Mock Test 2024 was modified by you', time: '2 hours ago' },
                        { icon: <CheckCircle2 className="text-emerald-500" size={18} />, bg: 'bg-emerald-50 dark:bg-emerald-950/20', title: 'Bulk Upload Complete', desc: 'Added 50 new questions to Physics', time: 'Yesterday' },
                     ].map((item, i) => (
                        <div key={i} className="flex items-start gap-4">
                           ...
                           <div className="flex-1 min-w-0">
                              ...
                              <p className="text-sm text-slate-500 dark:text-zinc-400 truncate">{item.desc}</p>
                           </div>
                  ...
                  <Button variant="ghost" className="w-full mt-6 text-indigo-600 dark:text-indigo-400 font-bold bg-indigo-50/50 dark:bg-indigo-950/20 hover:bg-indigo-50 dark:hover:bg-indigo-950/40">View All Activity</Button>
               </div>
            </div>
            ...
            <div className="space-y-6">
               ...
               <div className="grid grid-cols-1 gap-4">
                  ...
                  <button onClick={() => navigate('/settings')} className="flex items-center gap-4 p-5 rounded-2xl bg-card border border-border shadow-md dark:shadow-none hover:shadow-lg transition-all hover:-translate-x-1 text-left group">
                     <div className="h-10 w-10 rounded-xl bg-slate-100 dark:bg-zinc-800 flex items-center justify-center text-slate-600 dark:text-zinc-400 group-hover:bg-slate-600 group-hover:text-white transition-colors">
                        <Settings size={20} />
                     </div>
                     <div>
                        <p className="font-bold text-slate-800 dark:text-zinc-100">System Settings</p>
                        <p className="text-xs text-slate-500 dark:text-zinc-400">Configure application</p>
                     </div>
                  </button>
               </div>
            </div>
